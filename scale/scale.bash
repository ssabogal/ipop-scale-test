...
while true; do
		...
		("install")
		    # check if 'all' is present
                	...
                	node_list[$index]="${node_list[$index]} $i"
             	    ...
             	    # install iperf in nodes list of vnodes
            	    for i in $(seq 0 $(($NR_NODES - 1))); do
	...
	("mem")
	    ...
	    echo '    iperf              : test the network throughput through virtual link or direct link'
	    echo '    ping               : test the network delay through virtual link or direct link' 
            echo ''
            echo '  utility:'
